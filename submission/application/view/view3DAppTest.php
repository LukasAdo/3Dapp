      ...
      <div id="main" class="container-fluid main-contents" style="display: block;">
        ...
        <div class = "row">
          ...
          <div class = "col-sm-4">
            <div class = "card">
              ...
              <div class="card-body">
					...
					<a href="#" class="btn btn-danger" id="card-button-0">Find out more ...</a>
			  </div>
          </div>
        </div>
         ...
         <div class="col-sm-4">
            ...
            <a href="#" class="btn btn-danger" id="sprite-button">Find out more ...</a>
        </div>
    </div>
</div>
          ...
          <!--- Dr Pepper -->
         <div class="col-sm-4">
    <div class="card" id="dr-pepper-card">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-danger" id="dr-pepper-button">Find out more ...</a>
        </div>
    </div>
</div>
        <br>
	   ...
	   <div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<h4 class="card-title" id="gallery_sprite-title"></h4>
                    <p class="card-text" id="sprite-description"></p>
